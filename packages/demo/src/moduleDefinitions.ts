...
export const MODULE_DEFINITIONS: Record<string, ModuleDefinition> = {
  ...
  LFO: {
    ...
    inputs: 0,
    outputs: 1,
    defaultParams: { frequency: 1, amplitude: 1, waveform: 'sine', direction: 'up' },
  },
  ADSR: {
    type: 'ADSR',
    label: 'ADSR',
  ...
  Sequencer: {
    ...
    defaultParams: {
      steps: Array.from({ length: 8 }, () => ({ active: false, value: 0, lengthPct: 80, slide: false, accent: false })),
      division: 4,
      length: 8,
      swing: 0,
    },
